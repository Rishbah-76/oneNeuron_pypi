...
def prepare_data(df):
    """It is used to Seprate the dependent and Independent variable

    Args:
        df (df.DataFrame): Its the Pandas DataFrame
...
def save_model(model, filename):
    """It is sued to save the Model which is being Trained  
